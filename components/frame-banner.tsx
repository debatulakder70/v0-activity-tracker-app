...
export function FrameBanner({ username, user, casts, previousScore = 0, onShare, onImprove }: FrameBannerProps) {
                ...
                <svg className="transform -rotate-90 w-full h-full" viewBox="0 0 100 100">
                  ...
                  <defs>
                    <linearGradient id={`scoreGradient-${currentScore}`} x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor={tier.color.split(" ")[1]} />
                      <stop offset="100%" stopColor={tier.color.split(" ")[3]} />
                    </linearGradient>
                  </defs>
                  <circle
                    cx="50"
